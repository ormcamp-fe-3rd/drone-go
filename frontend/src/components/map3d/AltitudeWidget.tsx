...
const AltitudeWidget = ({ positionData }: AltitudeWidgetProp) => {
  ...
  return (
    <div className="relative mx-6 mt-2 hidden h-[5vh] w-[30vw] max-w-[19rem] grid-cols-2 items-center rounded-[10px] bg-white bg-opacity-80 px-2 text-center text-sm font-bold sm:grid md:grid-cols-[1fr_1.5fr] drop-shadow-md">
