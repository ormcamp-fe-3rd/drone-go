 ...
 */
export function calculateDistance(route: Telemetry2dPayloadSubset<"lat" | "lon" | "alt">[]) {
  let totalDistance = 0;
...
export function calculatePointAlongRoute(
  route: Telemetry2dPayloadSubset<"lat" | "lon" | "alt">[],
  distanceAlong: number,
): Telemetry2dPayloadSubset<"lat" | "lon" | "alt"> {
